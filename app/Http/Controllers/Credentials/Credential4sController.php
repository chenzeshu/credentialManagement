...
class Credential4sController extends Controller
{
    protected $repo;
    ...
    {
        $credentials = credential_4::orderBy('id', 'desc')->paginate(15);
    ...
    {
        $credential_4 = credential_4::find($id);
        $path = unserialize($credential_4->path);
    ...
    {
        $credential =  credential_4::find($id);
        //todo 删除文件
    ...
    public function deleteFile(Request $request)
    {
        ...
        $credential = credential_4::find($request->id);
