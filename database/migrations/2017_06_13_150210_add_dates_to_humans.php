...
class AddDatesToHumans extends Migration
{
    ...
    public function up()
    {
        Schema::table('humans', function (Blueprint $table) {
            $table->string('gather_title_at')->nullable();  //职称获取时间
            $table->string('gather_skill_at')->nullable();  //技能培训及个人荣誉获取时间  一期先一个,二期和skills捆绑成数组
            $table->string('graduated_at')->nullable(); //学历毕业时间
