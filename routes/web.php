...
//      人力资源
    Route::get('/humans/download/{path}', 'HumansController@download')->middleware('throttle:15,1');  //维护员等下载文件
...
//      资质
    Route::group(['namespace'=>'Credentials'], function (){
        Route::group(['middleware'=>'credentials_basic'],function (){
            Route::get('/credentials_basic/download/{path}', 'CredentialBasicController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_1'],function (){
            Route::get('/credentials_1/download/{path}', 'Credential1sController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_2'],function (){
            Route::get('/credentials_2/download/{path}', 'Credential2sController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_3'],function (){
            Route::get('/credentials_3/download/{path}', 'Credential3sController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_4'],function (){
            Route::get('/credentials_4/download/{path}', 'Credential4sController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_5'],function (){
            Route::get('/credentials_5/download/{path}', 'Credential5sController@download')->middleware('throttle:15,1');
        ...
        Route::group(['middleware'=>'credentials_6'],function (){
            Route::get('/credentials_6/download/{path}', 'Credential6sController@download')->middleware('throttle:15,1');
...
//      专利&软件著作权
    Route::group(['middleware'=>'patent'],function () {
        Route::get('/patents/download/{path}', 'PatentsController@download')->middleware('throttle:15,1');
    ...
    Route::group(['middleware'=>'soft'],function () {
        Route::get('/softs/download/{path}', 'SoftCertificatesController@download')->middleware('throttle:15,1');
